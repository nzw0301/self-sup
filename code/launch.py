r"""
Modification of https://github.com/pytorch/pytorch/blob/master/torch/distributed/launch.py for hydra.
...
def main():
    ...
    for local_rank in range(0, args.nproc_per_node):
        ...
        if not args.use_env:
            cmd.append("distributed.local_rank={}".format(local_rank))
            cmd.append("distributed.world_size={}".format(dist_world_size))
